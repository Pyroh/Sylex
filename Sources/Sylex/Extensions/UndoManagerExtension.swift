...
public extension UndoManager {
    public func registerUndo<TargetType: AnyObject, ValueType>(for key: ReferenceWritableKeyPath<TargetType, ValueType>, of target: TargetType, with actionName: String? = nil) {
